...
{
    /// <inheritdoc />
    public partial class AddIsBlackedField : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    isBlacked = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vehicle_No = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Gross_Price = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "635289", "Own board", "Honda CR-V", "Red", new DateTime(2023, 9, 20, 14, 34, 33, 872, DateTimeKind.Local).AddTicks(840), new DateOnly(2001, 3, 1), new DateOnly(2025, 3, 1), "Diesel", "Third party", 2004, "Vasanth Vihar", "Ram", new DateOnly(2031, 3, 1), new DateTime(2023, 9, 20, 14, 34, 33, 872, DateTimeKind.Local).AddTicks(840), "DL 89 JU 9921" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "DL 89 JU 9921", true, 1, new DateTime(2023, 9, 20, 14, 34, 33, 872, DateTimeKind.Local).AddTicks(850), "Some description", "D://car1.jpg", 0, 2, 2500000f, "635289", new DateTime(2023, 9, 20, 14, 34, 33, 872, DateTimeKind.Local).AddTicks(850) });
