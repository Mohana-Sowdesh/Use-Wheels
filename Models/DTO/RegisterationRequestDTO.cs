namespace Use_Wheels.Models.DTO
{
    ...
    {
        [RegularExpression("^[A-Za-z0-9_]+$", ErrorMessage = "Username can only contain letters, underscore and numbers.")]
        ...
        [RegularExpression("^(admin|seller|customer)$", ErrorMessage = "Please enter a valid role")]
